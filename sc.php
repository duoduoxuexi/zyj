...
function create() {
    ...
    var myid1 = myid;
    kd.href = 'https://www.youxuanma.cn/?id='+myid.value+'&url='+url.value;   //在这修改域名   替换就行
    kd.style = ''; 
    kd.innerText = 'https://www.youxuanma.cn/?id='+myid.value+'&url='+url.value; //两个都要替换    这就好了
  ...
  <body style="background-image: url(https://blog.mrabit.com/bing/today);">
    <div class="container">
      ...
      <ul class="nav nav-pills pull-right" role="tablist">
        <li role="presentation" class="active"><a href="https://www.youxuanma.cn/">优选源码库</a></li>
        <li role="presentation"><a href="https://jq.qq.com/?_wv=1027&k=yCnTfYDu" target="_blank">进入官方群</a></li>
      </ul>
      <h3 class="text-muted" align="left">
        <img src="https://z3.ax1x.com/2021/04/20/c7NmY6.png" width="150px" height="47px"></img><font color="#8968CD"><b>小朋友照妖镜</b></font>
      </h3>
    </div>
<hr class="hr1">
       <marquee style="color:red; font-size:large"><img src="https://z3.ax1x.com/2021/03/29/cC3HeJ.gif" width="35px" height="35px">欢迎使用小朋友照妖镜，请勿用于非法用途！本站源码由优选源码库www.youxuanma.cn免费提供</marquee>
...
<h3 class="panel-title">生成面板</h3>
        ...
        <div class="panel-body">
            ...
            <input type="text" style="background: rgba(255, 251, 251, 0.7)" class="form-control" id="myurl" value= 'https://www.youxuanma.cn' placeholder="请输入上传照片后要跳转的网址">
               <br>
      ...
      <div class="panel panel-primary" style="margin:1% 1% 1% 1%;background: rgba(255, 251, 251, 0.7)">
        <div class="panel-body">
          <div class="alert alert-info" role="alert">
            ...
            <font color="#e600ff"><br>站长QQ3500710050</font>
            <font color="#e600ff"><br>QQ群：736128661</font>
            <font color="#e600ff"><br><a href="https://www.youxuanma.cn/">本站源码由优选源码库www.youxuanma.cn免费提供</a></font>
        ...
        <p style="text-align:center">
            &copy; Powered by
          <a href="https://www.youxuanma.cn/">优选源码库</a>!</p>
